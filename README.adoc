...
----
spring.cache:
  <cache name>.expireAfterAccess: 500 # milliseconds, use hazelcast feature
  <cache name>.expireAfterWrite: 1000 # milliseconds, use hazelcast feature
  <cache name>.maximumSize: 10000 # own realization, nothing in hazelcast
----
